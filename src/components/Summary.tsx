      ...
      <StyledVerbalSummaryContainer>
        ...
        <div className="margin-bottom-xl margin-top-m">
          ...
          <StyledVerbalSummaryContainer>
            <StyledUl>
              <p>
                אנחנו מקווים שהשאלון ותוצאותיו העניקו לך ערך, ומזמינים אותך לקבל את הכלים הטובים והמחזקים של תוכנית עמית: אימונים, סדנאות, קהילות, טיפולי גוף-נפש ועוד המון. כולם בחינם, <br />
                כולם נבחרו כדי  לסייע לך בחזרה לשגרה מיטיבה. <br />
                מזמינים אותך לשם, כדי לבחור את מה שמתאים לך. 
              </p>
